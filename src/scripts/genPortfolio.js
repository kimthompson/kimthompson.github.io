// Possible categories: project, article, video or event. Articles don't have descriptions, while events don't have thumbnails. Only projects have long descriptions (i.e. expandable, not truncated at like 20 words)
import { format } from "date-fns";
import nuxtArticleImage from "../../images/portfolio/article-nuxt-github-pages_244x244.jpg";
import classical24Image from "../../images/portfolio/classical-24-2018_520x520.jpg";
import election2018Image from "../../images/portfolio/election-2018_300x300.jpg";
import liveFromHereImage from "../../images/portfolio/live-from-here-2018_290x290.jpg";
import npmTitanImage from "../../images/portfolio/npm-apmg-titan-2019_370x370.jpg";
import podcastEngineImage from "../../images/portfolio/podcast-engine-2019_396x396.jpg";
...
const portfolio = [
  ...
  },
  {
    ...
    long_description: "Catch me there all day, all four days!",
...
let portfolioTiles = document.getElementById("portfolio");
...
portfolio.map(tile => {
  ...
  link.setAttribute("href", tile.link);
  link.classList.add("item-inner");
  link.classList.add(`item-${tile.category}`);

  if (tile.thumbnail !== "") {
    let image = document.createElement("img");
    image.setAttribute("src", tile.thumbnail);
    image.setAttribute("alt", tile.short_description);
  ...
  let dateText = document.createTextNode(
    title.category === "project"
      ? format(tile.date, "MMMM D, YYYY")
      : format(tile.date, "MMMM YYYY")
  );
  ...
  if (tile.category === "event") {
    ...
    let descText = document.createTextNode(tile.long_description);
  ...
  portfolioTiles.appendChild(item);
});
